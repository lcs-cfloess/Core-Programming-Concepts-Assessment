...
let temperaturInCelsius : Double = 20
let temperaturInFahrenheit = temperaturInCelsius * 9 / 5 + 32
print("A temperature in degrees Celsius of \(temperaturInCelsius) is equal to \(temperaturInFahrenheit) in degrees Fahrenheit.")
